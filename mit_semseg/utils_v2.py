...
def evaluate_segmentation(pred, label, num_classes, score_averaging="weighted"):
    ...
    prec = precision_score(flat_pred, flat_label, average=score_averaging, zero_division=0.0)
    rec = recall_score(flat_pred, flat_label, average=score_averaging, zero_division=0.0)
    f1 = f1_score(flat_pred, flat_label, average=score_averaging, zero_division=0.0)
